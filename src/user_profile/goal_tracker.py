...
class GoalReminderSystem:
    ...
    def create_goal(self, title: str, target_value: float = None,
                    period: str = "weekly", category: str = "comprehensive",
                    start_date: str = None, end_date: str = None) -> CarbonGoal:
        """创建目标"""
        import uuid
    ...
    def get_goal_status(self, goal_id: str) -> Dict:
        ...
        return {
            ...
            "status": "completed" if goal.completed else ("on_track" if progress > 50 else "needs_effort")
        }
    ...
    def get_statistics(self) -> Dict:
        ...
        return {
            ...
            "本周新增": len([g for g in self.goals.values() 
                           if g.period == "weekly"])
        }
