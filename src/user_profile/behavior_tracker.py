...
class BehaviorTracker:
    ...
    def _save_behavior(self, user_id: str, category: str, action: str,
                     value: float, unit: str, carbon_kg: float):
        ...
        try:
            ...
            logging.getLogger(__name__).warning(
                "[BehaviorTracker] _save_behavior failed (non-fatal): %s", e,
            )
    ...
    def create_goal(self, title: str, target_value: float = None,
                  period: str = "weekly", category: str = "comprehensive") -> Dict:
        """创建目标"""
