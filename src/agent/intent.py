...
class IntentRecognizer:
    ...
    INTENT_PATTERNS = {
        ...
        IntentType.ACTION_REPORT: [
            "我今天", "我昨天", "刚买了", "做了", "尝试了", "安装了",
            "换了", "开始", "已经", "完成了", "入手了", "骑行",
            "走路", "坐公交", "开车", "用电", "用了", "买了"
        ],
        IntentType.FEEDBACK: [
            "采纳了", "有用", "不错", "不行", "太难了", "不适合",
            "太贵", "不方便", "学会了", "懂了", "谢谢", "好",
            "不好", "满意", "不满意", "继续", "加油"
        ],
        IntentType.GREETING: [
            "你好", "您好", "嗨", "hi", "hello", "早", "晚上好",
            "初次见面", "初次见面", "很高兴"
        ],
        IntentType.SUGGESTION_ACCEPT: [
            "好的", "可以", "试试", "了解了", "明白了", "同意",
            "就这样", "按照你说的", "好的建议", "不错的主意"
        ],
    ...
    # 实体关键词
    ENTITY_PATTERNS = {
        "出行方式": ["开车", "骑车", "步行", "公交", "地铁", "打车", "电动车", "自行车", "飞机", "火车"],
    ...
    # 低碳领域关键词
    LOW_CARBON_KEYWORDS = [
        "碳", "低碳", "环保", "绿色", "节能", "减排", "减碳", "可持续",
        "生态", "再生能源", "太阳能", "电动车", "植树", "碳汇",
        "碳足迹", "碳中和", "碳达峰", "温室气体", "二氧化碳"
    ]
    ...
    def _determine_response_type(self, intent: IntentType, is_low_carbon_topic: bool = False) -> str:
        """确定响应类型"""
